...
*/
	...
	return array(
		...
		'answered_qs_in_x' => 'Most replied questions in ^',
		'answered_qs_title' => 'Most replied questions',
		'answered' => 'replied',
		...
		'me' => 'me',
		'meta_order' => '^what^when^where^who', // you can reorder but DO NOT translate! e.g. <replied> <15 hours ago> <in Problems> <by me (500 points)>
		...
		'nav_login' => 'Login',
		'nav_logout' => 'Logout',
		'nav_most_answers' => 'Most responses',
		...
		'no_answers_found' => 'No responses found',
		'no_answers_in_x' => 'No responses in ^',
		...
		'no_una_questions_found' => 'No unreplied questions found',
		'no_una_questions_in_x' => 'No unreplied questions in ^',
		'no_unselected_qs_found' => 'No questions found without a selected reply',
		'no_unupvoteda_qs_found' => 'No questions found without an upvoted reply',
		'page_label' => 'Page:',
		'page_next' => 'next',
		...
		'recent_as_in_x' => 'Recently replied questions in ^',
		'recent_as_title' => 'Recently replied questions',
		'recent_cs_in_x' => 'Recently commented questions in ^',
		'recent_cs_title' => 'Recently commented questions',
		'recent_qs_as_in_x' => 'Recent questions and responses in ^',
		'recent_qs_as_title' => 'Recent questions and responses',
		...
		'selected' => 'selected',
		'send_button' => 'Send',
		'suggest_ask' => 'Help get things started by ^1proposing a question^2.',
		...
		'unanswered_qs_in_x' => 'Questions without responses in ^',
		'unanswered_qs_title' => 'Recent questions without responses',
		'unselected_qs_in_x' => 'Questions without a selected reply in ^',
		'unselected_qs_title' => 'Recent questions without a selected reply',
		'unupvoteda_qs_in_x' => 'Questions without an upvoted reply in ^',
		'unupvoteda_qs_title' => 'Recent questions without an upvoted reply',
